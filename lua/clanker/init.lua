...
--- @type table<integer, { handle: clanker.view.PanelHandle, key: integer, opts: table }>
local panels = {}
...
--- @return { handle: clanker.view.PanelHandle, key: integer, opts: table }|nil
...
function M.setup(opts)
  ...
  vim.api.nvim_create_user_command("Clanker", function(cmd)
    ...
    desc = "Toggle the clanker panel (:Clanker sessions for the session modal)",
    nargs = "?",
    complete = function()
      return { "sessions" }
    end,
