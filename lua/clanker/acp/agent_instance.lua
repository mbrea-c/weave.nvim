...
local ACPClient = require("clanker.acp.acp_client")

--- @class clanker.acp.AgentInstance
--- @field chat_widget clanker.ui.ChatWidget
--- @field agent_client clanker.acp.ACPClient
...
--- @private
--- @type table<clanker.UserConfig.ProviderName, clanker.acp.ACPClient|nil>
AgentInstance._instances = {}

--- @param provider_name clanker.UserConfig.ProviderName
