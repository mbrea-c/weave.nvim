...
--- @class clanker.acp.AgentModes
--- @field _modes clanker.acp.AgentMode[]
--- @field current_mode_id? string
local AgentModes = {}
AgentModes.__index = AgentModes

--- @return clanker.acp.AgentModes
...
--- @param modes_info clanker.acp.ModesInfo
...
--- @return clanker.acp.AgentMode|nil
...
function AgentModes:show_mode_selector(set_mode_callback)
  ...
  vim.ui.select(self._modes, {
    ...
    format_item = function(item)
      --- @cast item clanker.acp.AgentMode -- need to cast because `select` has a Generic, but not for `format_item`
...
function AgentModes:handle_agent_update_mode(mode_id)
  ...
  Logger.notify("Mode changed to: " .. mode_id, vim.log.levels.INFO, { title = "Clanker Mode changed" })
...
--- @return { modes: clanker.acp.AgentMode[], current_mode_id: string|nil }
...
--- @param snapshot { modes: clanker.acp.AgentMode[], current_mode_id: string|nil }
