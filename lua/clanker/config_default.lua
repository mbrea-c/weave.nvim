...
--- @field mcpServers? clanker.acp.McpServer[] Per-provider override of `mcp_servers`

--- @class clanker.UserConfig
--- @field debug boolean Log to the debug file (utils/logger.lua)
--- @field provider string Default provider (a key of `acp_providers`)
--- @field acp_providers table<string, clanker.acp.ACPProviderConfig|nil>
--- @field mcp_servers clanker.acp.McpServer[] MCP servers handed to EVERY provider over ACP (session/new), unless a provider sets its own `mcpServers`. The agent spawns/connects them.
local ConfigDefault = {
  debug = false,
