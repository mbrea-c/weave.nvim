...
--- @class clanker.store.State
--- @field entries clanker.store.ChatEntry[] Ordered chat transcript
...
--- @field permission clanker.store.PendingPermission|nil HEAD of the permission queue (the one shown); nil when none pending
...
--- @field meta clanker.store.SessionMeta Provider/agent/model/mode metadata
--- @field permission_mode clanker.store.PermissionMode How incoming permission requests are answered
...
--- @class clanker.store.SessionMeta
...
--- @class clanker.store.PendingPermission
...
--- @alias clanker.store.PermissionMode "normal" | "auto" | "allow_edits"

--- Ordered for cycling in the UI.
--- @type clanker.store.PermissionMode[]
local PERMISSION_MODES = { "normal", "auto", "allow_edits" }

--- Short human label per mode for the sidebar.
--- @type table<clanker.store.PermissionMode, string>
...
--- @param mode clanker.store.PermissionMode
...
--- @class clanker.store.SessionStore
--- @field state clanker.store.State The current snapshot (never mutated in place)
--- @field _subscribers fun(state: clanker.store.State)[]
--- @field _permission_queue clanker.store.PendingPermission[] FIFO of pending permission requests; state.permission mirrors the head
local SessionStore = {}
...
--- @return clanker.store.SessionStore store
function SessionStore:new()
  local instance = {
    --- @type clanker.store.State
    state = {
      entries = {},
      tool_calls = {},
      tool_call_order = {},
...
--- @param fn fun(state: clanker.store.State)
...
--- @private
--- @param mutate fun(draft: clanker.store.State)
...
--- @param entry clanker.store.ChatEntry
...
--- @param meta clanker.store.SessionMeta
...
--- @return clanker.store.PermissionMode
...
--- @return clanker.store.PermissionMode mode The new mode
...
--- @param permission clanker.store.PendingPermission
...
--- @return clanker.store.PendingPermission|nil
...
--- @return clanker.store.PendingPermission|nil removed
