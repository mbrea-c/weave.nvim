...
-- ClankerToolHeader*/ClankerToolKindTag* groups below; they are NOT derived
...
for status, fg in pairs(STATUS_DEFAULT_FG) do
  ...
  M.HEADER_HL[status] = "ClankerToolHeader" .. suffix
  M.KIND_TAG_HL[status] = "ClankerToolKindTag" .. suffix
...
M.THINKING_TAG_HL = "ClankerThinkingTag"
...
M.USER_MSG_HL = "ClankerUserMessage"
...
--- @type table<string, string>
M.TASK_ICON_HL = {
  in_progress = "ClankerTaskIconInProgress",
  completed = "ClankerTaskIconDone",
  failed = "ClankerTaskIconFailed",
}
...
M.TASK_DONE_HL = "ClankerTaskDone"
...
vim.api.nvim_create_autocmd("ColorScheme", {
  group = vim.api.nvim_create_augroup("ClankerTaskDoneHl", { clear = true }),
...
M.PROMPT_BORDER_HL = {
  normal = "ClankerPromptBorderNormal",
  auto = "ClankerPromptBorderAuto",
  allow_edits = "ClankerPromptBorderAllowEdits",
}
