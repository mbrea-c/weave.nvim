...
--- only when expanded.
--- @param props { store: clanker.store.SessionStore, block: table, expanded: boolean, awaiting: boolean, show_diff: boolean }
...
--- @param props { store: clanker.store.SessionStore, permission: clanker.store.PendingPermission, count: integer }
...
--- @param ctx table
--- @param props { store: clanker.store.SessionStore, prefs: clanker.view.Prefs }
