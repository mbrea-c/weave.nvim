...
--- @return clanker.registry.Entry entry
function M.add(opts)
  opts = opts or {}
  next_key = next_key + 1
  local entry = {
...
--- @param key integer
--- @return clanker.registry.Entry|nil
function M.get(key)
...
--- panel bound to it).
--- @param fn fun(entry: clanker.registry.Entry)
